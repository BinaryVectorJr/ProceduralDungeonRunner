//Credit - Mathew Spencer (Tarodev) - https://github.com/Matthew-J-Spencer/Ultimate-2D-Controller
...
namespace TarodevController {
    ...
    public class PlayerController : MonoBehaviour, IPlayerController {
        ...
        //#region USER: Trigger Detection

        //private void RecordTriggers()
        //{
        //    var pos = transform.position;
        //    RawMovement = new Vector3(_currentHorizontalSpeed, _currentVerticalSpeed); // Used externally
        //    var move = RawMovement * Time.deltaTime;
        ...
        //    // check furthest movement. If nothing hit, move and don't do extra checks
        //    var hit = Physics2D.OverlapBox(furthestPoint, _characterBounds.size, 0, _triggerLayer);
        //    if (!hit)
        //    {
        //        Debug.Log("Entered Trigger 1");
        //        transform.position += move;
        //        return;
        ...
        //        if (Physics2D.OverlapBox(posToTry, _characterBounds.size, 0, _triggerLayer))
        //        {
        //            transform.position = positionToMoveTo;
